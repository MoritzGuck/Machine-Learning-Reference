...
<!--
$$ t-statistic = \frac{\hat{X}- \mu}{\frac{sd}{\sqrt{n}}}$$
--> 

#### z-test

Same as t-test, but requires that the standard distribution of the population is known.

<!-- not recommended due to assumptions 

$$ z-statistic = \frac{X - \mu}{\sigma} $$

-->

#### Chi-squared test

Tests for significant relationships between categorical features.
